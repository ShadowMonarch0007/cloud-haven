            ...
            <section className="hidden w-1/2 items-center justify-center bg-brand p-10 lg:flex xl:w-2/5">
                <div className="flex max-h-[800px] max-w-[430px] flex-col justify-center space-y-12">
                    <div className="flex items-center">
                        <Image src="/assets/icons/logo.svg" alt="logo" width={82} height={82} className="h-auto" />
                        <h1 className="font-poppins font-[500] text-[37.42px] leading-[56.12px] text-white"><span className="font-semibold text-6xl">C</span>loud<span className="font-semibold text-6xl">H</span>aven</h1>
                    </div>
